...
const ChatContainer=()=>{
    ...
    return selectedUser?(
        <div className="h-full overflow-scroll hide-scrollbar relative backdrop-blur-lg">
            {/* header */}
            ...
            {/* chat-area */}
            <div className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll hide-scrollbar p-3 pb-6">
