...
const Sidebar=()=>{
    ...
    return(
        <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll hide-scrollbar text-white ${selectedUser ? "max-md:hidden":''}`}>
            <div className="pb-5">
                <div className="flex justify-between items-center">
                    <img src={assets.logo} alt="logo" className="max-w-40" />
                    <div className="relative py-2 group">
                        <img src={assets.menu_icon} alt="Menu" className="max-h-5 cursor-pointer" />
                        <div className="absolute top-7.5 right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-grey-100 hidden group-hover:block">
